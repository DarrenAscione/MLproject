...
1. **transmissionFileName**: the name of the file containing the name of the file with the transition parameters as generated by `transition_MLE.py`. Default value is `POS/transition.txt`
